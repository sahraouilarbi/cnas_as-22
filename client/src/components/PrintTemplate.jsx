 ...
 */
const SectionEtablissement = ({ data, isHosp, isSoins, isSejour }) => (
      ...
      <div className="mt-1 pt-1 border-t border-slate-200">
        ...
        <div className="pl-4 space-y-0.5">
          ...
          <div className="flex gap-3 items-center">
            ...
            <label className="flex items-center">
              <CheckBox
                checked={(isHosp || isSejour) && data.hosp_type_sejour === "prolongation"}
              />{" "}
        ...
        <div className="pl-4 space-y-0.5">
          ...
          <div className="flex gap-6 items-center">
            <div className="flex gap-3 items-center">
              ...
              <label className="flex items-center">
                <CheckBox checked={isSoins && data.soins_type_pec === "initiale"} />{" "}
                Initiale
              </label>
              <label className="flex items-center">
                <CheckBox checked={isSoins && data.soins_type_pec === "prolongation"} />{" "}
                Prolongation
              </label>
            </div>
            <DottedField
...
const TechnicalFooter = () => (
  <div className="absolute right-2 bottom-24 rotate-[-90deg] origin-right text-[6px] text-gray-500 font-sans uppercase tracking-tighter">
